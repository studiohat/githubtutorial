...
public class AutoCheckTime {
    ...
    public static void autoCheckTime() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        ...
                        for (int i = 1; i <= 68; i++) {
                            try {
                                ...
                                String date1 = TimeCalculator.timeAddHour(mSeatList.get(i-1).getStart_time(),Integer.parseInt(mSeatList.get(i-1).getReserve_time()));
